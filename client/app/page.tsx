...
import { SearchIcon, Briefcase, Building, Users, CheckCircleIcon } from "lucide-react";
  ...
  const features = [
    {
      ...
      description:
        "Discover a wide range of job openings across multiple industries and experiance levels.",
      benefits: [
    ...
    },
    {
      ...
      title: "Top Companies",
      description:
        "Engage with top-tier companies, from innovative startups to Fortune 500 corporations.",
      benefits: [
      ...
      <section className="py-20 bg-gradient-to-b from-[#d7dedc] to-[#7263f3]/5 text-primary-foreground">
        <div className="container mx-auto px-4 text-center text-black">
          <h1 className="text-4xl text-[#7263f3] md:text-5xl font-bold mb-6">
           Discover Your Ideal Job or Perfect Candidate 
          </h1>
      ...
      <section className="py-20 bg-[#f0f5fa]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold text-center mb-12">
            Why Choose{" "}
            <span className="text-[#7263f3] font-extrabold">JobNest</span>
          </h2>
